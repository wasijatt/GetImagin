...
const MiniHeroSection = ({head,chfont,Last, fhead,span}) => {
  return (
    <div className="w-full text-center flex flex-col justify-center items-center mt-6 md:mt-0  text-black">
      
    <h1 className="text-2xl md:text-5xl 2xl:text-[7rem] leading-tight z-30  w-90%] md:w-[40%] ">
      {fhead}
