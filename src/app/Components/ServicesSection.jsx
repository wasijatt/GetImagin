...
const ServicesSection = () => {
  useEffect(() => {
    ...
    // Create ScrollTriggers for each panel to snap between sections
    panels.forEach((panel, i) => {
      ScrollTrigger.create({
        trigger: panel,
        start: "top top", // Trigger when panel top reaches top
        pin: true,
        pinSpacing: false, // Prevents spacing between pinned panels
    ...
    ScrollTrigger.create({
      snap: {
        snapTo: 1 / (panels.length - 1), // Snap to each panel (based on the number of panels)
        duration: 0.5, // Duration for the snap effect
