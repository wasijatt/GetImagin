...
const OurWork = () => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-wrap justify-center items-center w-full overflow-hidden gap-4 ">
    ...
    <Link className="px-8 py-2 border-[1px] rounded-3xl hover:px-16 duration-1000 border-teal-400" href = {"#"}>view All Projects <span><FaArrowRight className="inline "  /></span>
    </Link>
    </div>
        </div>
    )
